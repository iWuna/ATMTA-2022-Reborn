...
/obj/machinery/vending/pizza
	...
	slogan_list = "Ah, can you feel that divine smell?;Si, my amico! Freshly baked!;Hawaiian is good to, admit it!;Feeling hungry? Nothing's better than a hot pizza!"
	ads_list = "HOT PIZZA!;Just baked! Trust me!"
	vend_delay = 80
	icon_state = "pizza"
...
/obj/machinery/vending/gunshop
	...
	ads_list = "Guuun?Maybe you want it?;Buy some Zincum;Wanna feel safe? Well, you can!"
	icon_state = "liberationstation"
	vend_reply = "Don't forget the license!"
	products = list(/obj/item/gun/projectile/automatic/pistol/enforcer = 5)
	prices = list(/obj/item/gun/projectile/automatic/pistol/enforcer = 2000)
...
/obj/machinery/vending/gunshop/vend(datum/data/vending_product/R, mob/user)
	...
	a.autosay("[user.name] purchased [currently_vending.name]", "[name]", "Security")
...
/obj/machinery/vending/medical_public
	...
	icon_state = "pubmed"
	slogan_list = "It pays to be safe!;It's safest to pay! ;We've gone green! Now using 100% recycled materials! ;Address all complaints about Public MiniMed services to FILE NOT FOUND for a swift response. ; Now 80% sterilized!"
