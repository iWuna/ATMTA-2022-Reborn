	...
	dat = {"
		...
		<html>
				...
				<ol>
                    ...
                    <li>The Chief Engineer is responsible for maintaining the integrity of the Excidium's Atmospherics System. Failure to maintain this integrity is grounds for termination;</li>
				...
				<ol>
                    ...
                    <li>Engineers are to maintain the integrity of the Excidium's Power Network. In addition, hotwiring the Gravitational Singularity Engine, Supermatter Engine or Tesla Engine is strictly forbidden;</li>
	...
	dat = {"
		...
		<html>
				...
				<ol>
					...
					<li>The Security Pod Pilot is not permitted to explore the area surrounding the station, and must therefore be confined to the immediate orbital area of the NSS Excidium, the NXS Klapaucius (the Telecomms Satellite) and the Mining/Research Asteroid. Exception is made if the Head of Security permits otherwise.</li>
				</ol><BR>
	...
	dat = {"
		...
		<html>
				...
				<ol>
					...
					<li>The Captain is not to leave the NSS Excidium unless given specific permission by Central Command, or it happens to be the end of the shift. This includes via space or via the Gateway. To do so is to be considered abandoning their posts and is grounds for termination;</li>
					...
					<li>The Captain, despite being in charge of the Excidium, is not independent from Nanotrasen. Any attempts to disregard general company policy are to be considered an instant condition for contract termination;</li>
